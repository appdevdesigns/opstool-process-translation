				...
				'site/labels/opstool-ProcessTranslation').then(function () {
					...
					AD.Control.OpsTool.extend('ProcessTranslation', {
						CONST: {
							...
							LANGUAGE_SELECTOR_INITIALIZED: 'TR_Language_Selector.Initialized',
							ITEM_ACCEPTED: 'TR_Transaction.Accepted',
							ITEM_SELECTED: 'TR_Transaction.Selected',
							POPULATE_FINISHED: 'TR_Transaction.Finished',
						},
						...
						initControllers: function () {
							...
							this.controllers.LanguageSelector = new LanguageSelector(this.element.find('.tr-languageselector'), { eventLanguageSelected: this.CONST.LANGUAGE_SELECTED, eventLanguageSelectorInitialized: this.CONST.LANGUAGE_SELECTOR_INITIALIZED, fromLanguageCode: this.data.fromLanguageCode, toLanguageCode: this.data.toLanguageCode });
							...
							this.controllers.TranslateWorkspace = new TranslateWorkspace(this.element.find('.tr-translateworkspace'), { eventItemAccepted: this.CONST.ITEM_ACCEPTED, eventPopulateFinished: this.CONST.POPULATE_FINISHED, fromLanguageCode: this.data.fromLanguageCode, toLanguageCode: this.data.toLanguageCode });
						},
						...
						initEvents: function () {
							...
							this.controllers.TranslateWorkspace.element.on(this.CONST.POPULATE_FINISHED, function () {
								_this.translate();
							});
							...
							this.controllers.LanguageSelector.element.on(this.CONST.LANGUAGE_SELECTOR_INITIALIZED, function () {
								_this.translate();
							})
						},
